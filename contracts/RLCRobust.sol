...
contract RLCRobust is ERC20, SafeMath, Ownable {
...
// credit and thanks to to https://www.reddit.com/user/izqui9 for this sanity check
// https://www.reddit.com/r/ethereum/comments/63s917/worrysome_bug_exploit_with_erc20_token/dfwmhc3/
  ...
  function transfer(address _to, uint256 _value) onlyUnlocked onlyPayloadSize(2 * 32) returns (bool success) {
    balances[msg.sender] = safeSub(balances[msg.sender], _value);
